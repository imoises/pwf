  ...
  <html>
    ...
    <body>
          ...
          if(isset($_SESSION['login']['rol'])){
            ...
            echo '
            <li id="iniciar" class="orange darken-4"><a href="/login">Iniciar sesión</a></li>
            ';
          }
      ?>
      </div>      
    ...
    <li><a href="/login/cerrarSesion">Cerrar sesión</a></li>
     ...
     <div class="parallax-container">
      ...
      <div class="parallax"><img class="responsive-img" src="../application/resources/img/fondito2.jpg"></div>
    </div>
   <style>
     #buscador{
      margin-top: 250px;
            ...
            <div class="row">
              ...
              <div class="col s4">
                ...
                <ul class="center">
                  ...
                  <li><a class="grey-text text-lighten-3" href="/registro/registrarComercio"><h6>Registra Comercio</h6></a></li>
